			...
			<table>
				<tr>
					...
					<td> <input type="text" name="id" maxlength="50" onkeydown="inputIdChk()">
						<input type="button" value="중복확인" onclick="openIdChk()" class="btn btn-success btn-sm"> <input
				...
				<tr>
					<td id="title">생일</td>
					<td><input type="text" name="birth_yy" maxlength="8"
						placeholder="ex) 000101"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="email_1" maxlength="30">@
						<input type="text" name="email_2" maxlength="15" placeholder=""
						size="25"></td>
						<td><input type="button" value="중복확인" onclick="openemail()" class="btn btn-success btn-sm"> <input
						type="hidden" name="idDuplication" value="Uncheck" >
				</td></tr>

				<tr>
					<td id="title">휴대전화</td>
					<td><input type="text" name="phone"  placeholder="-없이 입력바랍니다."/></td>
				</tr>
				<tr>
					...
					</select> <input type="text" name="me" maxlength="15" placeholder="답변"
						size="25"></td>
				</tr>
			</table>
			<br>
	...
	<div style="text-align: center;">
		<div id="btn-group" class="btn-group" aria-label="Basic example"
			...
			<form action="login.jsp" method="post">
				<button type="submit"
					class="btn btn-success btn-sm d-grid gap-2 mx-auto text-center">회원가입</button>
			</form>
		</div>
		<div id="btn-group" class="btn-group" aria-label="Basic example"
			style="display: inline-block;">
