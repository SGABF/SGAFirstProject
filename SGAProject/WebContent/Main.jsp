        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 ms-auto"><p class="lead">트레이너와 전화 혹은 문자를 통해 자세한 내용에 대해서는 상담이 가능하구요 ​ 나의 코치를 찾는웹을
					통하니 상담받는것도 굉장히 편하고 여러 다양한 정보를 획득한 후 선택한 트레이너는 만족도가 굉장히 높았습니다 ​
					여러분들도 운동웹을 한번 사용해보시면 아주 좋을 것 같네요 ㅎㅎㅎ</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">비싼 금액이지만 의지가 약해서 트레이너 선생님들이 잘 관리해주시니
...
운동기구 사용법을 다 알 수 있으니 시간이 지나도 꾸준히 스스로 할 수 있기 때문에 초보자자분들은 꼭 PT 한번쯤 경험하는 것을 추천합니다!!</p></div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="lead mb-0">
                            20, Migeumil-ro 74beon-gil, Bundang-gu, Seongnam-si, Gyeonggi-do, Republic of Korea
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; SGAProject 2022 <br> Chrome 97.0.4692.99v 버전에 최적화되어 있습니다. <br> <a href="welcomeForm2.jsp">이용약관</a></small></div>
        </div>
        <!-- Portfolio Modals-->
        <!-- Portfolio Modal 1-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <p class="mb-4">트레이너 김영숙</p><p>경력 : 10년<p>xx 체육 대학교 출신</p>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-4">트레이너 김영삼</p> <p>경력 : 15년차</p> <p> xx 체육대학교 출신</p>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-4">트레이너 : 다니엘</p> <p>경력 : 5년차</p> <p>호주 대학교 출신</p>
