...
<style type="text/css">
	...
	#inputContent {
		width: 500px; border: 3px solid gray; background-color: rgba(255, 255, 128, 1.0);
...
<body>
	...
	<div id="inputContent">
		<h2>새로운 일정입력</h2>
		<div>하루종일 : <input type="checkbox" id="allDay" value="true"/></div>
		<div>일정이름 : <input type="text" id="title"/></div>
		<div>일정시작 : <input type="text" id="start1" /></div>
		<div>일정종료 : <input type="text" id="end1"/></div>
		<div>일정설명 : <textarea id="content" cols="50" rows="5"></textarea> </div>
		<div>글자색상 : 
			<select  id="textColor">
