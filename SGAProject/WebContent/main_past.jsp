...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<div class="navbar navbar-expand-lg navbar-light bg-light" id="bs-example-navbar-collapse-3">
			<ul class="nav navbar-expand-lg navbar-light bg-light" id="bs-example-navbar-collapse-3">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-hashpopup="true" aria-expanded="false">접속하기</a>
			...
			%>
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-hashpopup="true" aria-expanded="false">회원관리</a>
					<ul class="dropdown-menu">
		...
		<div class="jumbotron">
			<div class="container">
				...
				<div>
					<div>
						<h2>review</h2>
						<p style="font-size: 15px;">트레이너와 전화 혹은 문자를 통해 자세한 내용에 대해서는 상담이 가능하구요 ​ 나의 코치를 찾는웹을 통하니 상담받는것도 굉장히 편하고 여러 다양한 정보를 획득한 후 선택한 트레이너는 만족도가 굉장히 높았습니다 ​ 여러분들도 운동앱 운동닥터를 한번 사용해보시면 아주 좋을 것 같네요 ㅎㅎㅎ</p>
					</div>
				</div>
			</div>
			<br />
