...
<body id="page-top">
	...
	<div class="container d-flex align-items-center flex-column">
		...
		<div id="wrap">
			...
			<form method="post" action="MemberJoinAction.do" name="userInfo" class="userInfo"
				id=""
				...
				<table>
					<tr>
						...
						<td><input type="text" name="id" id="id" maxlength="50"
							...
							value="중복확인" onclick="openIdChk()" class="btn btn-success btn-sm">
					...
					<tr>
						...
						<td><input type="text" name="birth_yy" maxlength="8"
							placeholder="ex) 000101" /></td>
					</tr>

					<tr>
						<td id="title">이름</td>
						<td><input type="text" name="name" id="name" class="name" maxlength="40"></td>
					</tr>
					<tr>
						<td id="title">닉네임</td>
