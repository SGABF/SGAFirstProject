				...
				<div id="member_modify">
					...
					<table>
						<tr>
							<td>아이디</td>
							<td>
								<input type="text" name="uPassword" id="m_password" disabled="disabled" value="<%=id%>">
							</td>
							<td></td>
							<td></td>
						</tr>
						...
						<tr>
							<td>이름</td>
							<td>
								<input type="text" name="uPassword" id="m_password" value="<%=name%>">
							</td>
							<td></td>
							<td></td>
						</tr>
						<tr>
							<td>닉네임</td>
							<td>
								<input type="text" name="id" maxlength="20" value="<%=nickName%>">
							<td></td>
						</tr>
						...
						<tr>
							<td>전화번호</td>
							<td>
								<input type="text" name="number_1" maxlength="11" placeholder="-없이 ex)01012345678 입력바랍니다." value="<%=phone%>">
							</td>
						</tr>
						<tr>
							<td>이메일</td>
						...
						<tr>
							<td>생일</td>
							<td>
								<input type="text" name="email" maxlength="20" value="<%=birth%>">
							</td>
							<td></td>
