		...
		<div class="container d-flex align-items-center flex-column">
			...
			<form action="Main.jsp" method="post">
				...
				<div id="DeleteForm">
					...
					<p style="font-size: 20pt; font-weight: bold">회원탈퇴</p>
					<br>
				</div>

				정말로 회원정보를 삭제하시겠습니까? <br> <br> <br>

				<button type="submit" class="btn btn-success btn-sm" id="id_confirm_btn" onclick="alert('회원탈퇴가 정상처리되었습니다.');">확인</button>

				<button type="submit" class="btn btn-success btn-sm" id="id_confirm_btn" onclick="window.open('Deletecheck.jsp');">취소</button>
			</form>
</body>
</html>